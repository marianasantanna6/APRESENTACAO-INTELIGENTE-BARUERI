  ...
  return (
    <div className="group relative">
      <div
        ...
        className="cursor-pointer rounded-[18px] transition duration-200 hover:-translate-y-1 hover:shadow-[0_18px_38px_-28px_rgba(13,82,131,0.6)] focus:outline-none focus:ring-4 focus:ring-[#1675b8]/15"
      >
